...
public class SCRM25CreateAccount_MandatoryFields_Correct extends BaseTest{
    ...
    public void testApp() throws InterruptedException, IOException {
        ...
        pageCreateAccount.fillInFieldsMandatoryFieldsCorrect();

        File scrFile = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
        FileUtils.copyFile(scrFile, new File("/Users/nasrodo/SCRM25.png"));
