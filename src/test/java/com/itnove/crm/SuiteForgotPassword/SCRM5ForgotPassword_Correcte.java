...
public class SCRM5ForgotPassword_Correcte extends BaseTest {

    @Test
    public void testApp() throws InterruptedException, IOException {

        PageForgotPassword pageForgotPassword = new PageForgotPassword(driver);
        pageForgotPassword.forgotPassword("user", "cristina@barcelonaactiva.cat");
        ...
        FileUtils.copyFile(scrFile, new File("/Users/nasrodo/SCRM5.png"));
